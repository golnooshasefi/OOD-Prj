...
function AdditionalQuestion() {
  ...
  return (
    <div className={classes.Survey__container}>
      <div className={classes.Survey__container__headerContainer}>
        <div className={classes.Survey__container__headerContainer__header}>
          <span className={classes.Survey__container__headerContainer__text}>
            لیست علاقه‌مندی‌ها
          </span>
        </div>
      </div>
